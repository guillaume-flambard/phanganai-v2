...
import { Check, Wallet, Star, PartyPopper } from 'lucide-react';
                ...
                <div className="bg-primary/5 border border-primary/10 rounded-xl p-6 backdrop-blur-md">
                    ...
                    <div className="flex justify-between items-end">
                        ...
                        <div className="text-right">
                            <div className="text-lg font-semibold">OXA Main Bar</div>
            ...
            <div className="px-6 mb-12">
                <div className="bg-gradient-to-br from-primary/10 to-transparent border border-primary/20 rounded-xl p-6 relative overflow-hidden">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                            <h3 className="font-bold">+25 Points Earned!</h3>
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="h-3 w-full bg-white/10 rounded-full overflow-hidden p-0.5">
                            <div className="h-full bg-gradient-to-r from-primary to-yellow-400 rounded-full" style={{ width: '87.5%' }} />
                        </div>
